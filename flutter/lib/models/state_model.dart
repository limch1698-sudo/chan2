...
class StateGlobal {
  ...
  // --- 스피커 아이콘 표시를 위한 오디오 상태 맵 ---
  // key: 원격 컴퓨터의 ID, value: 오디오 재생 여부(true/false)
  final RxMap<String, bool> audioPlayingStates = <String, bool>{}.obs;

  // 오디오 상태를 업데이트하는 함수
  void setAudioPlaying(String id, bool isPlaying) {
    if (audioPlayingStates[id] != isPlaying) {
      audioPlayingStates[id] = isPlaying;
    }
  }
